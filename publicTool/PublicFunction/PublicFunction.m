...
+ (MBProgressHUD *)myShow:(NSString *)title
{
...
//    [HUD hide:YES afterDelay:5];
    //加上边框
//    UIView *borderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, hud.size.width, hud.size.height)];
//    borderView.layer.borderWidth = 1;
//    borderView.backgroundColor = [UIColor clearColor];
//    [hud addSubview:borderView];
