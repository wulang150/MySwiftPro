...
+ (NSString *)cachesFolderPath
{
    ...
    return [NSHomeDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"Library/Caches/%@image.png",@"123456789"]];
}
...
+(UIColor *)ChangeUIImageToUIColor:(NSString *)pngName{
    return [UIColor colorWithPatternImage:[UIImage imageNamed:@"EmailBackground.png"]];
}
